              ...
              <div className="flex flex-col gap-4">
                <div className="border border-[#e8e6f0] rounded-2xl p-4 flex flex-col gap-2.5">
                  ...
                  {campaign.contentDos.length === 0 && campaign.contentDonts.length === 0 ? (
                    <p className="text-xs text-[#9a99b0] italic">
            ...
            {activeTab === 'deliverables' && (
              <div className="flex flex-col gap-4">
                <div className="bg-[#f3f0ff] rounded-2xl p-4">
                  <p className="text-xs font-bold text-[#4f46e5] mb-1">
                    Content Guidelines Reminder
                  </p>
                  <p className="text-xs text-[#5a5a8a] leading-relaxed">
                    Create your content off-platform, then return to submit the link for brand
                    review. Keep your content within the brief guidelines. Submit content within the
                    next 3-5 days
                  </p>
                </div>
