              ...
              <div className="bg-[#faf9fc] border border-[#e8e6f0]/60 rounded-3xl p-5 flex flex-col gap-4 text-left">
                ...
                <div className="grid grid-cols-2 gap-x-6 gap-y-3.5 text-xs">
                  {[
                    ...
                    >
                      <span className="text-[10px] font-semibold text-[#9a99b0]">{row.label}</span>
                ...
                <div className="border-t border-[#e8e6f0]/40 pt-4.5">
                  <h3 className="text-xs font-bold text-[#1a1a2e] mb-3.5">Brand Representative</h3>
                  <div className="grid grid-cols-2 gap-x-6 gap-y-3.5 text-xs">
                    {[
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex flex-col gap-0.5">
                          <span className="text-[10px] font-medium text-[#9a99b0]">{m.label}</span>
