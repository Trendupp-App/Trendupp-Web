...
export const InstagramSignInButton = forwardRef<SocialSignInHandle, Props>(
  function InstagramSignInButton({ role, acceptedTerms, acceptedPromotions, onRequireTerms }, ref) {
    function handleClick() {
      if (!acceptedTerms) {
        onRequireTerms?.();
        return;
      ...
      sessionStorage.setItem(
        INSTAGRAM_PENDING_KEY,
        JSON.stringify({ role, redirectUri, acceptedTerms, acceptedPromotions }),
      );
