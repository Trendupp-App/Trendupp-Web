...
//       },
//     );
//   }, [session?.idToken, exchangeGoogleToken, onRequireTerms, router]);
...
export const GoogleSignInButton = forwardRef<SocialSignInHandle, Props>(function GoogleSignInButton(
  ...
  }, [session?.idToken, exchangeGoogleToken, onRequireTerms, router, onResumeTermsAccepted]);
