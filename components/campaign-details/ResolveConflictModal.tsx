    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
      <div className="bg-white rounded-2xl w-full max-w-[480px] p-6 shadow-2xl flex flex-col gap-4">
        ...
        <p className="text-sm text-[#4a4a6a] leading-relaxed">
          ...
          <span className="font-semibold text-[#1a1a2e]">{creatorName}</span>&apos;s submission. If
          this still doesn&apos;t meet requirements, our team will step in to mediate. Explain
