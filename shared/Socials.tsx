export const PLATFORMS = [
  {
    ...
    usernameKey: 'instagramUsername' as const,
  ...
  },
  {
    ...
    usernameKey: 'youtubeUsername' as const,
  ...
  },
  {
    ...
    usernameKey: 'tiktokUsername' as const,
  ...
  },
  {
    ...
    usernameKey: 'twitterUsername' as const,
  ...
  },
  {
    ...
    usernameKey: 'facebookUsername' as const,
    followersKey: 'facebookFollowers' as const,
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
