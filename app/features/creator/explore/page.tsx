...
interface Brand {
  ...
  bio?: string;
  industries?: string[];
  platforms?: { name: string; handle: string; followers: string; icon: 'instagram' | 'tiktok' | 'youtube' | 'twitter' }[];
...
const MOCK_BRANDS: Brand[] = [
  {
    ...
    completedCampaigns: [
      { id: 1, image: 'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?auto=format&fit=crop&w=400&q=80', brandName: 'Zara' },
      { id: 2, image: 'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?auto=format&fit=crop&w=400&q=80', brandName: 'Zara' },
      { id: 3, image: 'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?auto=format&fit=crop&w=400&q=80', brandName: 'Zara' },
      { id: 4, image: 'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?auto=format&fit=crop&w=400&q=80', brandName: 'Zara' },
      { id: 5, image: 'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?auto=format&fit=crop&w=400&q=80', brandName: 'Zara' },
      { id: 6, image: 'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?auto=format&fit=crop&w=400&q=80', brandName: 'Zara' },
    ],
  },
  {
    id: 2,
    ...
    completedCampaigns: [
      { id: 1, image: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80', brandName: 'Tecno' },
      { id: 2, image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=400&q=80', brandName: 'Tecno' },
      { id: 3, image: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?auto=format&fit=crop&w=400&q=80', brandName: 'Tecno' },
    ],
  },
  {
    id: 3,
    ...
    completedCampaigns: [
      { id: 1, image: 'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?auto=format&fit=crop&w=400&q=80', brandName: 'Audiomack' },
      { id: 2, image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=400&q=80', brandName: 'Audiomack' },
      { id: 3, image: 'https://images.unsplash.com/photo-1484755560695-a4c748918c29?auto=format&fit=crop&w=400&q=80', brandName: 'Audiomack' },
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    completedCampaigns: [
      { id: 1, image: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=400&q=80', brandName: 'Nestlé' },
      { id: 2, image: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?auto=format&fit=crop&w=400&q=80', brandName: 'Nestlé' },
    ],
  },
  {
    id: 7,
    ...
    completedCampaigns: [
      { id: 1, image: 'https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?auto=format&fit=crop&w=400&q=80', brandName: 'Monster' },
      { id: 2, image: 'https://images.unsplash.com/photo-1607962837359-5e7e89f86776?auto=format&fit=crop&w=400&q=80', brandName: 'Monster' },
    ],
  },
  {
    id: 8,
    ...
    completedCampaigns: [
      { id: 1, image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=400&q=80', brandName: 'GTBank' },
      { id: 2, image: 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?auto=format&fit=crop&w=400&q=80', brandName: 'GTBank' },
      { id: 3, image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=400&q=80', brandName: 'GTBank' },
    ],
  },
];
...
const MOCK_CREATORS: Creator[] = [
  {
    ...
    portfolio: [
      { id: 1, image: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=400&q=80', brandName: 'Zara' },
      { id: 2, image: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=400&q=80', brandName: 'Nestle' },
    ],
  },
  {
    id: 2,
    ...
    platforms: [
      { name: 'Instagram', handle: 'sadefoods', followers: '55K', icon: 'instagram' },
    ],
    portfolio: [
      { id: 1, image: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=400&q=80', brandName: 'Techno' },
    ],
  },
  {
    id: 3,
    ...
    platforms: [
      { name: 'Instagram', handle: 'sadefoods', followers: '32K', icon: 'instagram' },
    ],
    portfolio: [
      { id: 1, image: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=400&q=80', brandName: 'Nestle' },
    ],
  },
  {
    id: 4,
    ...
    platforms: [
      { name: 'Instagram', handle: 'amaraosei', followers: '310K', icon: 'instagram' },
    ],
    portfolio: [
      { id: 1, image: 'https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?auto=format&fit=crop&w=400&q=80', brandName: 'Tara' },
    ],
  },
  {
    id: 5,
    ...
    platforms: [
      { name: 'Instagram', handle: 'bayospeaks', followers: '890K', icon: 'instagram' },
    ],
    portfolio: [
      { id: 1, image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=400&q=80', brandName: 'GTBank' },
    ],
  },
  {
    ...
    platforms: [
      { name: 'Instagram', handle: 'chidistyle', followers: '44K', icon: 'instagram' },
    ],
    portfolio: [
      { id: 1, image: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=400&q=80', brandName: 'Zara' },
    ],
  },
  {
    id: 7,
    ...
    platforms: [
      { name: 'Instagram', handle: 'amaraosei', followers: '38K', icon: 'instagram' },
    ],
    portfolio: [
      { id: 1, image: 'https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?auto=format&fit=crop&w=400&q=80', brandName: 'Tara' },
    ],
  },
  {
    ...
    platforms: [
      { name: 'Instagram', handle: 'amaraosei', followers: '45K', icon: 'instagram' },
    ],
    portfolio: [
      { id: 1, image: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&w=400&q=80', brandName: 'Zara' },
    ],
  },
];
...
export default function ExplorePage() {
  ...
  const filteredBrands = MOCK_BRANDS.filter((brand) => {
    ...
    if (!matchesSearch) return false;
    if (activeBrandFilter !== 'All' && brand.category.toLowerCase() !== activeBrandFilter.toLowerCase()) return false;
    return true;
  });
  ...
  const filteredCreators = MOCK_CREATORS.filter((creator) => {
    ...
    if (!matchesSearch) return false;
    if (activeCreatorFilter !== 'All' && creator.category.toLowerCase() !== activeCreatorFilter.toLowerCase()) return false;
    return true;
  });
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
          <div className="bg-white border border-[#e8e6f0]/60 rounded-3xl overflow-hidden shadow-sm flex flex-col">
            ...
            <div className="p-5 flex flex-col gap-2.5">
              <span className="text-[11px] font-bold text-brand-pink tracking-wider uppercase">Platform News</span>
              ...
              <p className="text-xs text-[#7a7a9a] font-light line-clamp-2 leading-relaxed">
                Nigerian content creators can now apply to earn money directly from TikTok based on video views, engagement, and reach...
              </p>
          ...
          <div className="bg-white border border-[#e8e6f0]/60 rounded-3xl overflow-hidden shadow-sm flex flex-col">
            ...
            <div className="p-5 flex flex-col gap-2.5">
              <span className="text-[11px] font-bold text-brand-pink tracking-wider uppercase">Awards</span>
              <h3 className="text-base font-bold text-[#1a1a2e] leading-snug hover:text-brand-pink transition-colors cursor-pointer">
                Trendupp Awards 2025: Nominations officially open next week
              </h3>
              <p className="text-xs text-[#7a7a9a] font-light line-clamp-2 leading-relaxed">
                The annual celebration of creativity, influence, and impact on social platforms in Nigeria returns for its 5th edition...
              </p>
